...
echo '--- final states ---'
for s in auto_sync auto_sync_web halo2 immich immich-ml tbox_client tbox-logrotate.timer nginx cron mysql postgresql redis-server privoxy waiwei xray; do
