...
| --- | --- | --- | --- | --- |
| shadowsocks | • 部署目录: `/opt/usr/local/shadowsocks`<br>• 状态:<br>&emsp;• shadowsocks disable/stop<br>&emsp;• shadowsocks-rust disable/stop | • 部署目录: `/usr/local/shadowsocks`<br>• 状态:<br>&emsp;• shadowsocks disable/stop<br>&emsp;• shadowsocks-rust disable/stop | • 部署目录: `/usr/local/shadowsocks`<br>• 状态:<br>&emsp;• shadowsocks disable/stop<br>&emsp;• shadowsocks-rust enable/start | • 部署目录: `/usr/local/shadowsocks`<br>• 状态:<br>&emsp;• shadowsocks enable/start<br>&emsp;• shadowsocks-rust disable/stop |
| xray | • 部署目录: `/opt/usr/local/xray`<br>• 状态:<br>&emsp;• disable/stop | • 部署目录: `/usr/local/xray`<br>• 状态:<br>&emsp;• disable/stop | • 部署目录: `/usr/local/xray`<br>• 状态:<br>&emsp;• disable/stop | × |
| tbox | • 部署目录: `/opt/usr/local/tbox`<br>• 状态:<br>&emsp;• tbox-client enable/start | × | • 部署目录: `/usr/local/tbox`<br>• 状态:<br>&emsp;• tbox-server enable/start | × |
| rblog | × | × | • 部署目录: `/usr/local/blog`<br>• 状态:<br>&emsp;• enable/start<br>• 备份: `rblog-backup.timer` -> `rblog-backup.service` | × |
| waiwei | • 部署目录: `/opt/usr/local/waiwei`<br>• 状态:<br>&emsp;• waiwei-puller disable/stop<br>&emsp;• waiwei-web disable/stop | • 部署目录: `/usr/local/waiwei`<br>• 状态:<br>&emsp;• waiwei-puller disable/stop<br>&emsp;• waiwei-web disable/stop | • 部署目录: `/usr/local/waiwei`<br>• 状态:<br>&emsp;• waiwei-puller disable/stop<br>&emsp;• waiwei-web disable/stop | × |
| auto_sync | • 部署目录: `/opt/usr/local/auto_sync`<br>• 状态:<br>&emsp;• enable/start | • 部署目录: `/usr/local/auto_sync`<br>• 状态:<br>&emsp;• enable/start | × | × |
| domus | • 部署目录: `/opt/usr/local/domus`<br>• 状态:<br>&emsp;• enable/start<br>• 备份: `domus-backup.timer` -> `domus-backup.service` | × | × | × |
| rgit | • 部署目录: `/opt/usr/local/rgit`<br>• 状态:<br>&emsp;• enable/start<br>• 备份: `rgit-backup.timer` -> `rgit-backup.service` | × | × | × |
| mysql | • 部署目录: `/etc/mysql`<br>• 状态:<br>&emsp;• disable/stop | • 部署目录: `/etc/mysql`<br>• 状态:<br>&emsp;• enable/start | × | × |
| postgres | • 部署目录: `/etc/postgresql`<br>• 状态:<br>&emsp;• disable/stop | • 部署目录: `/etc/postgresql`<br>• 状态:<br>&emsp;• enable/start | × | × |
| redis | • 部署目录: 系统默认<br>• 状态:<br>&emsp;• disable/stop | • 部署目录: 系统默认<br>• 状态:<br>&emsp;• enable/start | × | × |
...
| 静态站点根目录 | × | × | × | × |
| flutter sdk | • 路径: `/opt/src/software/flutter`<br>• 状态:<br>&emsp;• 使用<br>• 环境: `FLUTTER_ROOT` | • 路径: `/root/src/software/flutter`<br>• 状态:<br>&emsp;• 使用 | × | × |
| nvm root | • 路径: `/opt/src/software/tools/nvm`<br>• 状态:<br>&emsp;• `NVM_DIR` | • 路径: `/root/src/software/tools/nvm`<br>• 状态:<br>&emsp;• `NVM_DIR` | × | × |
| node.js | • 路径: `/opt/src/software/tools/nvm/versions/node/v24.18.0`<br>• 状态:<br>&emsp;• 使用 | • 路径: `/root/src/software/tools/nvm/versions/node/v24.18.0`<br>• 状态:<br>&emsp;• 使用 | × | × |
...
| pgvector | • 路径: `/opt/src/software`<br>• 状态:<br>&emsp;• 使用 | • 路径: `/root/src/software`<br>• 状态:<br>&emsp;• 使用 | × | × |
| openwrt toolchain | × | • 路径: `/root/src/software/openwrt`<br>• 状态:<br>&emsp;• 构建使用 | × | • 状态:<br>&emsp;• 接收构建产物 |
