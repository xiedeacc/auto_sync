...
nginx vhost、gitlab、MySQL、PostgreSQL、immich、tbox、waiwei、xray、rblog、logrotate 等服务专用文件，会从 collector share 复制到它们正常的系统位置。它们应和对应的 collect 路径保持一致，不要在脚本里临时散落生成。
