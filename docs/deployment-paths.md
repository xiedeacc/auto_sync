...
| --- | --- | --- | --- | --- |
| shadowsocks | • 部署目录: `/usr/local/shadowsocks`<br>• 状态: 停止/禁用 | • 部署目录: `/opt/usr/local/shadowsocks`<br>• 状态: 停止/禁用 | • 部署目录: `/usr/local/shadowsocks`<br>• 状态: `shadowsocks-rust.service` 运行 | • 部署目录: `/usr/local/shadowsocks`<br>• 状态: `shadowsocks` 运行，`xray-plugin` 随 shadowsocks 链路使用 |
| xray | • 部署目录: `/usr/local/xray`<br>• 状态: 停止/禁用 | • 部署目录: `/opt/usr/local/xray`<br>• 状态: 停止/禁用 | • 部署目录: `/usr/local/xray`<br>• 状态: 停止/禁用 | × |
| tbox | × | • 部署目录: `/opt/usr/local/tbox`<br>• 状态: `tbox_client.service` 运行，`tbox-logrotate.timer` 运行 | • 部署目录: `/usr/local/tbox`<br>• 状态: `tbox_server.service` 运行 | × |
| rblog | × | × | • 部署目录: `/usr/local/blog`<br>• 状态: `rblog.service` 运行，`rblog-backup.timer` 运行 | × |
| waiwei | • 部署目录: `/usr/local/waiwei`<br>• 状态: 停止/禁用 | • 部署目录: `/opt/usr/local/waiwei`<br>• 状态: 停止/禁用 | • 部署目录: `/usr/local/waiwei`<br>• 状态: 停止/禁用 | × |
| auto_sync | • 部署目录: `/usr/local/auto_sync`<br>• 状态: 运行 | • 部署目录: `/opt/usr/local/auto_sync`<br>• 状态: 运行 | × | × |
| domus | × | • 部署目录: `/opt/usr/local/domus`<br>• 状态: `domus.service` 运行，`domus-backup.timer` 运行 | × | × |
| rgit | × | • 部署目录: `/opt/usr/local/rgit`<br>• 状态: `rgit.service` 运行，`rgit-backup.timer` 运行，`rgit-ocsp.timer` 运行 | × | × |
| mysql | • 部署目录: `/etc/mysql`<br>• 状态: 运行 | • 部署目录: `/etc/mysql`<br>• 状态: 停止/禁用 | × | × |
| postgres | • 部署目录: `/etc/postgresql`<br>• 状态: 运行 | • 部署目录: `/etc/postgresql`<br>• 状态: 停止/禁用 | × | × |
| redis | • 部署目录: 系统默认<br>• 状态: 运行 | • 部署目录: 系统默认<br>• 状态: 停止/禁用 | × | × |
