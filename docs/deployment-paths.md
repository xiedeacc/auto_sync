...
| waiwei | • 部署目录: `/usr/local/waiwei`<br>• 状态: puller disable/stop，web disable/stop | • 部署目录: `/opt/usr/local/waiwei`<br>• 状态: puller disable/stop，web disable/stop | • 部署目录: `/usr/local/waiwei`<br>• 状态: puller disable/stop，web disable/stop | × |
