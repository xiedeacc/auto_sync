...
| waiwei | • **部署目录**:<br>&emsp;• `/opt/usr/local/waiwei`<br>• **状态**:<br>&emsp;• waiwei-puller disable/stop<br>&emsp;• waiwei-web disable/stop | • **部署目录**:<br>&emsp;• `/usr/local/waiwei`<br>• **状态**:<br>&emsp;• waiwei-puller disable/stop<br>&emsp;• waiwei-web disable/stop | • **部署目录**:<br>&emsp;• `/usr/local/waiwei`<br>• **状态**:<br>&emsp;• waiwei-puller disable/stop<br>&emsp;• waiwei-web disable/stop | × |
